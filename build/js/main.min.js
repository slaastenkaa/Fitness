...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/slider/slider":11,"./modules/tabs/init-tabs":12,"./modules/video/video":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
function initSlider() {
  var trainersSlider = new _swiper.default('.trainers__slider', {
...
function initVideo() {
  var button = document.querySelector('[data-button-video]');
  var figure = document.querySelector('[data-figure-video]');
